...
//     qubits: &[i32],
//     sol_elem: i64,
// ) -> Result<(), QuestError> { let sol_ctrls = &qubits .iter()
...
//     qureg: &mut Qureg<'_, N>,
//     qubits: &[i32],
// ) -> Result<(), QuestError> { // apply H to transform |+> into |0>
//   tensor_gate(qureg, Qureg::hadamard, qubits) // apply X to transform |11..1>
//   into |00..0> .and(qureg.multi_qubit_not(qubits))?;
